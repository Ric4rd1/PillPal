...
try:
    while True:
        ...
        mensaje = input("Ingresa un mensaje para publicar en 'laptop/ricard': ")

        # Publicar el mensaje en el tópico 'laptop/ricard'
        client.publish("laptop/ricard", mensaje)
